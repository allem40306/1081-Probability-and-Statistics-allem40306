...
% call MarrHildreth algorithm
MarrHildreth(grayIm, "lena");
MarrHildreth(grayIm2, "headCT");
MarrHildreth(grayIm3, "dentalXray");

function MarrHildreth(grayIm, name)
    for windowSz = 3:2:7
        for sigma = 0.1:0.2:0.9
            for threshold = 0:10:50
                ...
                imwrite(resIm, name + windowSz + "_" + sigma + "_" + threshold + ".png");
            end
        end
    end
end
